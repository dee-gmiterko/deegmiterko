...
% \vspace{0.25cm}
% \cvitem{Architecture}{Being built as a monorepo of TypeScript packages for back-end (micro)services, front-end applications (React PWA, Material UI), and tooling, allowed me to easily ensure type coherence across the whole project from database ORM up to display components themselves.}
