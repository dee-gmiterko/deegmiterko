    ...
    <>
      <div className="position-relative">
        ...
        <div style={{
          ...
          <p>
            I made a full local environment of Docker services, while a custom dev. server takes care of automatic package and image builds, service restarts, orchestrated together.
          </p>
        </div>
      </div>
      <div className="grow" />
